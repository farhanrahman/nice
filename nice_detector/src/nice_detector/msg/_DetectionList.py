"""autogenerated by genpy from nice_detector/DetectionList.msg. Do not edit."""
import sys
...
class DetectionList(genpy.Message):
  ...
  _type = "nice_detector/DetectionList"
...
"""
  ...
  _slot_types = ['std_msgs/Header','nice_detector/Detection[]','sensor_msgs/Image']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = nice_detector.msg.Detection()
        _v19 = val1.box
        _v20 = _v19.header
        start = end
        end += 4
        ...
        if python3:
          _v19.ns = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v19.text = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v19.mesh_resource = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v29.encoding = str[start:end].decode('utf-8')
        else:
  ...
  def deserialize_numpy(self, str, numpy):
    ...
    try:
      ...
      for i in range(0, length):
        ...
        if python3:
          _v55.ns = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v55.text = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v55.mesh_resource = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v65.encoding = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v65.data = str[start:end].decode('utf-8')
        else:
        ...
        if python3:
          _v70.data = str[start:end].decode('utf-8')
        else:
