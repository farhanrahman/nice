#ifndef NICE_DETECTOR_HPP
#define NICE_DETECTOR_HPP
...
{
class NiceDetector : public nodelet::Nodelet{
	private:
		StrongClassifier* classifier;
		nice_detector::Rect trackedPatch;
		nice_detector::Size img_size;
  ...
  public:
		...
		nice_detector::prediction::Response getKalmanPrediction();
